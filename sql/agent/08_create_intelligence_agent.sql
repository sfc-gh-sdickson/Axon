...
instructions:
  ...
  sample_questions:
    - question: 'How many agencies do we have in total?'
      answer: 'I will query the agency data to count total agencies in the system.'
    - question: 'What is our total revenue?'
      answer: 'I will use the Sales Revenue Intelligence view to calculate total revenue from all orders.'
    - question: 'Show me all product families we offer.'
      answer: 'I will query the product catalog to list all available product families.'
    - question: 'How many support tickets are currently open?'
      answer: 'I will use the Support Quality Intelligence view to count open support tickets.'
    - question: 'What is the average customer satisfaction score?'
      answer: 'I will query support ticket data to calculate the average satisfaction score across all agencies.'
